...
async function startConsumer() {
  try {
    ...
    await consumer.subscribe({ topic: 'leaderboard.events', fromBeginning: true });
    console.log('Subscribed to leaderboard events');
    
    await consumer.subscribe({ topic: 'tournament.events', fromBeginning: true });
    console.log('Subscribed to tournament events');
    ...
    await consumer.run({
      eachMessage: async ({ topic, partition, message }) => {
        try {
          ...
          console.log(`Processing ${topic} event:`, event);
          ...
          switch (topic) {
            ...
            case 'tournament.events':
              // TODO: Implement tournament event processing
              console.log('Tournament event processing not yet implemented');
              break;
            case 'quest.events':
              // TODO: Implement quest event processing
              console.log('Quest event processing not yet implemented');
              break;
          }
        } catch (error) {
